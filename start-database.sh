...
DB_CONTAINER_NAME="my-invest-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=my-invest -d -p 5432:5432 docker.io/postgres
